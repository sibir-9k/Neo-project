...
export const ClaimForm = () => {
	...
	return (
		<>
			...
			<Select label="Type" className="form-type__select" onChangeType={(e) => setForm({...form, type: e.target.value})} value={form.type} onChangeValid={(e) => type.onChange(e)} onBlur={(e) => type.onBlur(e)} />
